function Lesson_06() {
  // 1 тип: string - строковый - типизируем
  let userFullName: string = "John Johnson";
  // Пробуем передать userFullName 30 - будет ошибка!!!
  // userFullName = 30;

  let hello = `Hello. ${userFullName}`; //  если мы явно(указано прямо) не прописываем тип переменной, то тип назначается автоматически, в зависимости от того, какое значение было переданно изначально для переменной
